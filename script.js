...
const winimageContainer = document.querySelector('.winimage');
const attemptContainer = document.querySelector('.attempt');


const classList = ['image11', 'image11', 'image12', 'image12', 'image13', 'image13', 'image14', 'image14', 'image15', 'image15', 'image16', 'image16', 'image17', 'image17', 'image18', 'image18'];
const filteredList = ['image11', 'image12', 'image13', 'image14', 'image15', 'image16', 'image17', 'image18'];
...
function winMessage() {
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            var objdataa = $.parseJSON(data);
            console.log(objdataa);
            localStorage.setItem('score_var',objdataa.valuee);
            alert(objdataa.message);
            if(objdataa.valuee == 1){
                // localStorage.clear();
                //localStorage.removeItem('score_var');
               
                window.location='./index.php';
                //localStorage.clear();
            }else if(objdataa.valuee == 2){
                window.location='./index.php';
            }else if(objdataa.valuee == 3){
